...
class AppNewWindow:
    def __init__(self):
        ...
        button = tk.Button(self.root, text="Open new window", command=self.open_window)
        button.pack()

        # maximize
        button2 = tk.Button(self.root, text="zoomed", command=self.window_zoomed)
        button2.pack(padx=5, pady=5)

        # hidden
        button3 = tk.Button(self.root, text="withdrawn", command=self.window_withdrawn)
        button3.pack(padx=5, pady=5)

        # minimized
        button4 = tk.Button(self.root, text="iconic", command=self.window_iconic)
        button4.pack(padx=5, pady=5)

        # normal
        button5 = tk.Button(self.root, text="normal", command=self.window_normal)
        button5.pack(padx=5, pady=5)

        # minimizes
        button6 = tk.Button(self.root, text="iconify", command=self.window_iconify)
        button6.pack(padx=5, pady=5)

        # minimizes
        button7 = tk.Button(self.root, text="deiconify", command=self.window_deiconify)
