...
def ziplookup():
    ...
    try:
        api_request = requests.get(
            f"https://www.airnowapi.org/aq/forecast/zipCode/?format=application/json&zipCode={zipcode}&date=2021-10-21&distance=25&API_KEY="
        )
    ...
    mylabel = tk.Label(
        root, text=label, font=("Helvetica", 20), background=weather_color
    )
