...
class TkinterApp:
    ...
    def __init__(self, appname="TkinterApp", width=400, heigth=400):
        ...
        self.style.map(self.appname, background=[("selected", selectedrow_color)])
    ...
    def update_record(self):
        ...
        if (
            not self.name_entry.get()
            or not self.id_entry.get()
            or not self.topping_entry.get()
        ):
    ...
    def insert_record(self):
        ...
        self.insert_data(
            self.name_entry.get(), self.id_entry.get(), self.topping_entry.get()
        )
        self.name_entry.delete(0, END)
        self.id_entry.delete(0, END)
        self.topping_entry.delete(0, END)
