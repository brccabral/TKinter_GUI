...
class TkinterApp:
    ...
    def open_popup(self):
        ...
        label = tk.Label(self.pop, text="Would you like to proceed?", bg=pop_main_color, fg="white")
        label.pack(pady=10)
        ...
        yes_button = tk.Button(frame, text="YES", command=lambda: self.pop_choice('yes'), bg="orange")
        yes_button.grid(row=0, column=1, padx=5)
        no_button = tk.Button(frame, text="NO", command=lambda: self.pop_choice('no'), bg="red")
